...
public class GCVenus2ComponentVillageTorch extends GCVenus2ComponentVillage
{
    private int averageGroundLevel = -1;

    public GCVenus2ComponentVillageTorch(GCVenus2ComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static StructureBoundingBox func_74904_a(GCVenus2ComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6)
    {
