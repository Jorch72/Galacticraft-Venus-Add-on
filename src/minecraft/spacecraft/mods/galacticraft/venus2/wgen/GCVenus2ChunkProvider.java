...
import spacecraft.mods.galacticraft.venus2.wgen.dungeon.*;
import spacecraft.mods.galacticraft.venus2.wgen.village.*;
...
public class GCVenus2ChunkProvider extends ChunkProviderGenerate
{
    ...
    public GCVenus2BiomeDecorator biomedecoratorplanet = new GCVenus2BiomeDecorator(GCVenus2BiomeGenBase.venusFlat);

    private final World worldObj;
    private final GCVenus2MapGenVillage villageGenerator = new GCVenus2MapGenVillage();
    ...
    {
        this.dungeonGenerator.otherRooms.add(new GCVenus2RoomEmpty(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.otherRooms.add(new GCVenus2RoomSpawner(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.otherRooms.add(new GCVenus2RoomSpawner(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.otherRooms.add(new GCVenus2RoomSpawner(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.otherRooms.add(new GCVenus2RoomSpawner(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.otherRooms.add(new GCVenus2RoomSpawner(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        ...
        this.dungeonGenerator.otherRooms.add(new GCVenus2RoomSpawner(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.otherRooms.add(new GCVenus2RoomSpawner(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.otherRooms.add(new GCVenus2RoomChests(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.otherRooms.add(new GCVenus2RoomChests(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.bossRooms.add(new GCVenus2RoomBoss(null, 0, 0, 0, ForgeDirection.UNKNOWN));
        this.dungeonGenerator.treasureRooms.add(new GCVenus2RoomTreasure(null, 0, 0, 0, ForgeDirection.UNKNOWN));
    }

    private BiomeGenBase[] biomesForGeneration = { GCVenus2BiomeGenBase.venusFlat };

    private final GCCoreMapGenBaseMeta caveGenerator = new GCVenus2GenCaves();
    ...
    public GCVenus2ChunkProvider(World par1World, long par2, boolean par4)
    {
    ...
    public void generateTerrain(int chunkX, int chunkZ, short[] idArray, byte[] metaArray)
    {
        ...
        for (int x = 0; x < GCVenus2ChunkProvider.CHUNK_SIZE_X; x++)
        {
            for (int z = 0; z < GCVenus2ChunkProvider.CHUNK_SIZE_Z; z++)
            {
                ...
                for (int y = 0; y < GCVenus2ChunkProvider.CHUNK_SIZE_Y; y++)
                {
                    if (y < GCVenus2ChunkProvider.MID_HEIGHT + yDev)
                    {
...
//            var13 = 58;
//            var14 = var5 + this.rand.nextInt(16) + 8;
//            new GCVenusWorldGenVolcano().generate(this.worldObj, this.rand, var12, var13, var14);
//        }
