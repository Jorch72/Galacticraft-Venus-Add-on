...
public class GCVenus2RoomEmpty extends GCCoreDungeonRoom
{
    ...
    public GCVenus2RoomEmpty(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new GCVenus2RoomEmpty(dungeon, x, y, z, dir);
    }
