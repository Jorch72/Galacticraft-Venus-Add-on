...
public class GCVenus2RoomTreasure extends GCCoreDungeonRoom
{
    ...
    public GCVenus2RoomTreasure(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new GCVenus2RoomTreasure(dungeon, x, y, z, dir);
    }
