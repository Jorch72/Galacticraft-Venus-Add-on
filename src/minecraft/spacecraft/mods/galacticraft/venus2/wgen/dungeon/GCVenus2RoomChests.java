...
public class GCVenus2RoomChests extends GCCoreDungeonRoom
{
    ...
    public GCVenus2RoomChests(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new GCVenus2RoomChests(dungeon, x, y, z, dir);
    }
