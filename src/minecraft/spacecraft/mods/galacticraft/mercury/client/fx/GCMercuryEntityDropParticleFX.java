package spacecraft.mods.galacticraft.mercury.client.fx;
...
public class GCMercuryEntityDropParticleFX extends EntityFX
{
    ...
    public GCMercuryEntityDropParticleFX(World par1World, double par2, double par4, double par6, Material par8Material)
    {
