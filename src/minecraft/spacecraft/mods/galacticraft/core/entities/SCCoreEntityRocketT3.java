...
public class SCCoreEntityRocketT3 extends EntityTieredRocket implements IInventory
{
    ...
    public void onTeleport(EntityPlayerMP player)
    {
        ...
        if (playerBase != null)
        {
            ...
            playerBase.setRocketItem(SCCoreItems.spaceship);
    ...
    {
        droppedItems.add(new ItemStack(SCCoreItems.spaceship, 1, this.rocketType.getIndex()));
