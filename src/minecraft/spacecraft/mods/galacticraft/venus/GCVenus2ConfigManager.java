...
public class GCVenus2ConfigManager
{
    ...
    public static int idItemVenusBow;
    ...
    private void setDefaultValues()
    {
        try
        {
            ...
            GCVenus2ConfigManager.idItemVenusBattery = GCVenus2ConfigManager.configuration.get(Configuration.CATEGORY_ITEM, "idItemVenusBattery", 9995).getInt(9995);
            GCVenus2ConfigManager.idItemVenusBow = GCVenus2ConfigManager.configuration.get(Configuration.CATEGORY_ITEM, "idToolVenusbow", 9991).getInt(9991);
