...
public class GCVenusItemReinforcedBucket extends GCVenusItem
{
        public int isFull;

    public GCVenusItemReinforcedBucket(int par1, int par2)
    {
        super(par1);
        this.maxStackSize = 1;
        this.isFull = par2;
    ...
    public ItemStack onFoodEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
            ...
            if (this.itemID != GCVenusItems.reinforcedBucketMilk.itemID)
            {
        ...
        return par1ItemStack.stackSize <= 0 ? new ItemStack(GCVenusItems.reinforcedBucketEmpty) : par1ItemStack;
    }
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
            ...
            else
            {
                if (var12.typeOfHit == EnumMovingObjectType.TILE)
                {
                    ...
                    if (this.isFull == 0)
                    {
                        ...
                        if (par2World.getBlockMaterial(var13, var14, var15) == Material.water && par2World.getBlockMetadata(var13, var14, var15) == 0)
                        {
                            ...
                            {
                                    final ItemStack bucket = new ItemStack(GCVenusItems.reinforcedBucketWater);
                        ...
                        if (par2World.getBlockMaterial(var13, var14, var15) == Material.lava && par2World.getBlockMetadata(var13, var14, var15) == 0)
                        {
                            ...
                            if (--par1ItemStack.stackSize <= 0)
                            {
                                    final ItemStack bucket = new ItemStack(GCVenusItems.reinforcedBucketLava);
                                    bucket.setTagCompound(new NBTTagCompound());
                                    bucket.getTagCompound().setInteger("bucketUses", 2);
                                return bucket;
                            }
                        ...
                        if (par2World.getBlockMaterial(var13, var14, var15) == GCVenusBlocks.bacterialSludge && par2World.getBlockMetadata(var13, var14, var15) == 0)
                        {
                            par2World.setBlockWithNotify(var13, var14, var15, 0);
                            ...
                            if (--par1ItemStack.stackSize <= 0)
                            {
                                    final ItemStack bucket = new ItemStack(GCVenusItems.reinforcedBucketBacteria);
                                    bucket.setTagCompound(new NBTTagCompound());
                                    bucket.getTagCompound().setInteger("bucketUses", 2);
                                return bucket;
                            }

                            if (!par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(GCVenusItems.reinforcedBucketBacteria)))
                            {
                                    final ItemStack bucket = new ItemStack(GCVenusItems.reinforcedBucketBacteria);
                                    bucket.setTagCompound(new NBTTagCompound());
                                    bucket.getTagCompound().setInteger("bucketUses", 2);
                    ...
                    else
                    {
                        if (this.isFull < 0)
                        {
                            return new ItemStack(GCVenusItems.reinforcedBucketEmpty);
                        }
                ...
                {
                    return new ItemStack(GCVenusItems.reinforcedBucketMilk);
                }
    ...
    public boolean tryPlaceContainedLiquid(World par1World, double par2, double par4, double par6, int par8, int par9, int par10)
    {
        ...
        {
            if (par1World.provider.isHellWorld && this.isFull == GCVenusItems.reinforcedBucketWater.itemID)
            {
