...
public class GCVenusItemSulferFuel extends Item
{
    protected Icon[] icons = new Icon[7];

    public GCVenusItemSulferFuel(int id, String assetName)
    {
        super(id);
    ...
    public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5)
    {
        if (par1ItemStack.getMaxDamage() - par1ItemStack.getItemDamage() == 0)
        {
            ...
            if (!(par1ItemStack.getItem() instanceof GCVenusItemSulferCanister))
            {
                par1ItemStack = new ItemStack(GCVenusItems.sulferCanister, stackSize, GCVenusItems.sulferCanister.getMaxDamage());
            }
        }
    }
