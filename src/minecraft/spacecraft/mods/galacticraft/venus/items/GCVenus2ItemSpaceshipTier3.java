...
public class GCVenus2ItemSpaceshipTier3 extends Item implements IHoldableItem
{
    public GCVenus2ItemSpaceshipTier3(int par1)
    {
        super(par1);
        this.setMaxDamage(0);
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            if (amountOfCorrectBlocks == 9)
            {
                ...
                {
                    rocket = new GCVenus2EntityRocketT3(par3World, centerX, centerY + 0.2D, centerZ, EnumRocketType.values()[par1ItemStack.getItemDamage()]);
                }
                else
                {
