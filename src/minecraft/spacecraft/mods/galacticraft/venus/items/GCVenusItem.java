...
{
    public static String[] names = { "ingotSulfer", "ingotGem", "itemGem", "reinforcedVenusPlateT3", "venusPlate", "redGemPlate", "sulferPlate", "venusPowerCrystal", "venusPowerCell", "emptyCell", "rawBasalt", "basaltBrick", "vurnBerry" };
