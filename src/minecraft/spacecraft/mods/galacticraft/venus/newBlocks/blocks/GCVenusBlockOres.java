...
public class GCVenusBlockOres extends Block implements IDetectableResource, IPlantableBlock, ITileEntityProvider, ITerraformableBlock
{
    @SideOnly(Side.CLIENT)
    private Icon[] venus2BlockIcons;

    public GCVenusBlockOres(int i)
    {
        super(i, Material.rock);
        this.blockHardness = 3.0F;
        this.setUnlocalizedName("venusBlock");
    }
