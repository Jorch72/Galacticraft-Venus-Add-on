...
public class GCVenus2RoomBoss extends GCCoreDungeonRoom
{
    ...
    public GCVenus2RoomBoss(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new GCVenus2RoomBoss(dungeon, x, y, z, dir);
    }
