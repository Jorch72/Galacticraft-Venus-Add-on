...
public class GCVenus2RoomSpawner extends GCCoreDungeonRoom
{
    int sizeX;
    int sizeY;
    int sizeZ;
    ...
    public GCVenus2RoomSpawner(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
        return new GCVenus2RoomSpawner(dungeon, x, y, z, dir);
    }
    ...
    protected void handleTileEntities(Random rand)
    {
        for (final ChunkCoordinates spawnerCoords : this.spawners)
        {
            ...
            if (spawner != null)
            {
                spawner.getSpawnerLogic().setMobID(GCVenus2RoomSpawner.getMob(rand));
            }
        }
    }
