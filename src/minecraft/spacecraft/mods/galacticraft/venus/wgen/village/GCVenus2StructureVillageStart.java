...
class GCVenus2StructureVillageStart extends StructureStart
{
    @SuppressWarnings("unchecked")
    public GCVenus2StructureVillageStart(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        final ArrayList<GCVenus2StructureVillagePieceWeight> var6 = GCVenus2StructureVillagePieces.getStructureVillageWeightedPieceList(par2Random, par5);
        final GCVenus2ComponentVillageStartPiece var7 = new GCVenus2ComponentVillageStartPiece(par1World.getWorldChunkManager(), 0, par2Random, (par3 << 4) + 2, (par4 << 4) + 2, var6, par5);
        ...
        while (var13.hasNext())
        {
            ...
            if (!(var12 instanceof GCVenus2ComponentVillageRoadPiece))
            {
                ++var10;
            }
        }
