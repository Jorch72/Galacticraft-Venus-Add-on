...
public class GCVenus2ComponentVillageHouse extends GCVenus2ComponentVillage
{
    private int averageGroundLevel = -1;

    public GCVenus2ComponentVillageHouse(GCVenus2ComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static GCVenus2ComponentVillageHouse func_74921_a(GCVenus2ComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        final StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(par3, par4, par5, 0, 0, 0, 17, 9, 17, par6);
        return StructureComponent.findIntersecting(par1List, var8) == null ? new GCVenus2ComponentVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6) : null;
    }
