...
public class GCVenus2ComponentVillageWell extends GCVenus2ComponentVillage
{
    private int averageGroundLevel = -1;

    public GCVenus2ComponentVillageWell(GCVenus2ComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, int par4, int par5)
    {
    ...
    {
        GCVenus2StructureVillagePieces.getNextStructureComponentVillagePath((GCVenus2ComponentVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 1, this.getComponentType());
        GCVenus2StructureVillagePieces.getNextStructureComponentVillagePath((GCVenus2ComponentVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 3, this.getComponentType());
        GCVenus2StructureVillagePieces.getNextStructureComponentVillagePath((GCVenus2ComponentVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, 2, this.getComponentType());
        GCVenus2StructureVillagePieces.getNextStructureComponentVillagePath((GCVenus2ComponentVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, 0, this.getComponentType());
    }
