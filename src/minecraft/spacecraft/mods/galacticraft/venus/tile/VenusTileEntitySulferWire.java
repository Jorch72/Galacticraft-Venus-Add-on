...
public class VenusTileEntitySulferWire extends GCCoreTileEntityUniversalConductor
{
    public float resistance;
    public float amperage;

    public VenusTileEntitySulferWire()
    {
        this(0.05F, 200.0F);
    }

    public VenusTileEntitySulferWire(float resistance, float amperage)
    {
