...
{
    private static final ResourceLocation cargoRocketTexture = new ResourceLocation(GCVenus.TEXTURE_DOMAIN, "textures/model/cargoRocket.png");
    private IModelCustom cargoRocketModel;

    public GCVenusItemRendererSpaceshipT3(IModelCustom cargoRocketModel)
    {
        super(new GCVenusEntityRocketT3(FMLClientHandler.instance().getClient().theWorld), new GCVenusModelSpaceshipTier3(), new ResourceLocation(GCVenus.TEXTURE_DOMAIN, "textures/model/rocketT3.png"));
    ...
    protected void renderSpaceship(ItemRenderType type, RenderBlocks render, ItemStack item, float translateX, float translateY, float translateZ)
    {
        ...
        {
            FMLClientHandler.instance().getClient().renderEngine.bindTexture(GCVenusItemRendererSpaceshipT3.cargoRocketTexture);
