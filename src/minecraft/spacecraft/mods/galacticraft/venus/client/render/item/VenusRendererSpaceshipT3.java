package spacecraft.mods.galacticraft.venus.client.render.item;
...
import spacecraft.mods.galacticraft.venus.client.model.VenusModelSpaceshipTier3;
...
public class VenusRendererSpaceshipT3 extends GCCoreItemRendererSpaceship
{
    ...
    public VenusRendererSpaceshipT3(IModelCustom cargoRocketModel)
    {
        super(new VenusEntityRocketT3(FMLClientHandler.instance().getClient().theWorld), new VenusModelSpaceshipTier3(), new ResourceLocation(GalacticraftVenus.TEXTURE_DOMAIN, "textures/model/rocketT3.png"));
    ...
    protected void renderSpaceship(ItemRenderType type, RenderBlocks render, ItemStack item, float translateX, float translateY, float translateZ)
    {
        ...
        {
            FMLClientHandler.instance().getClient().renderEngine.bindTexture(VenusRendererSpaceshipT3.cargoRocketTexture);
