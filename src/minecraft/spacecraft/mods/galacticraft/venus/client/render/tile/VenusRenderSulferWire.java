...
public class VenusRenderSulferWire extends TileEntitySpecialRenderer
{
    private static final ResourceLocation sulferWireTexture = new ResourceLocation(GalacticraftVenus.TEXTURE_DOMAIN, "textures/model/sulferWire.png");

    public final IModelCustom model;
    public final IModelCustom model2;

    public VenusRenderSulferWire()
    {
    ...
    public void renderModelAt(VenusTileEntitySulferWire tileEntity, double d, double d1, double d2, float f)
    {
        // Texture file
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(VenusRenderSulferWire.sulferWireTexture);
        GL11.glPushMatrix();
    ...
    {
        this.renderModelAt((VenusTileEntitySulferWire) tileEntity, var2, var4, var6, var8);
    }
}
