...
import spacecraft.mods.galacticraft.venus.blocks.GCVenus2BlockT3TreasureChest;
...
public class GCVenus2TileEntityTreasureChestRenderer extends TileEntitySpecialRenderer
{
    ...
    public void renderGCTileEntityTreasureChestAt(GCCoreTileEntityTreasureChest par1GCTileEntityTreasureChest, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            ...
            {
                ((GCVenus2BlockT3TreasureChest) var10).unifyAdjacentChests(par1GCTileEntityTreasureChest.getWorldObj(), par1GCTileEntityTreasureChest.xCoord, par1GCTileEntityTreasureChest.yCoord, par1GCTileEntityTreasureChest.zCoord);
                var9 = par1GCTileEntityTreasureChest.getBlockMetadata();
            }
        ...
        if (par1GCTileEntityTreasureChest.adjacentChestZNeg == null && par1GCTileEntityTreasureChest.adjacentChestXNeg == null)
        {
            ...
            if (par1GCTileEntityTreasureChest.adjacentChestXPos == null && par1GCTileEntityTreasureChest.adjacentChestZPos == null)
            {
                ...
                this.bindTexture(GCVenus2TileEntityTreasureChestRenderer.treasureChestTexture);
            }
            else
            {
                var14b = this.largeChestModel;
                this.bindTexture(GCVenus2TileEntityTreasureChestRenderer.treasureLargeChestTexture);
            }
