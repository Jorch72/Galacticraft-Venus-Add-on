...
import spacecraft.mods.galacticraft.venus.inventory.GCVenus2ContainerRocketBenchT3;
...
public class GCVenus2GuiSchematicRocketT3 extends GuiContainer implements ISchematicResultPage
{
    ...
    public GCVenus2GuiSchematicRocketT3(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
    {
        super(new GCVenus2ContainerRocketBenchT3(par1InventoryPlayer, x, y, z));
        this.ySize = 238;
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        this.mc.renderEngine.bindTexture(GCVenus2GuiSchematicRocketT3.tier3SchematicTexture);
