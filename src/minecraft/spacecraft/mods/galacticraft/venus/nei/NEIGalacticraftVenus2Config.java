...
public class NEIGalacticraftVenus2Config implements IConfigureNEI
{
    ...
    {
        NEIGalacticraftVenus2Config.rocketBenchRecipes.put(input, output);
    }

    public static Set<Entry<ArrayList<PositionedStack>, PositionedStack>> getRocketBenchRecipes()
    {
        return NEIGalacticraftVenus2Config.rocketBenchRecipes.entrySet();
    }
    ...
    public void registerRecipes()
    {
        ...
        this.registerRocketBenchRecipe(input1, new PositionedStack(new ItemStack(GCVenus2Items.spaceship, 1, 0), 139, 87 + changey));
        ...
        this.registerRocketBenchRecipe(input2, new PositionedStack(new ItemStack(GCVenus2Items.spaceship, 1, 1), 139, 87 + changey));
        ...
        input2.add(new PositionedStack(new ItemStack(Block.chest), 90 + 0 * 26, -15 + changey));
        input2.add(new PositionedStack(new ItemStack(Block.chest), 90 + 1 * 26, -15 + changey));
        this.registerRocketBenchRecipe(input2, new PositionedStack(new ItemStack(GCVenus2Items.spaceship, 1, 2), 139, 87 + changey));
        ...
        input2.add(new PositionedStack(new ItemStack(Block.chest), 90 + 1 * 26, -15 + changey));
        input2.add(new PositionedStack(new ItemStack(Block.chest), 90 + 2 * 26, -15 + changey));
        this.registerRocketBenchRecipe(input2, new PositionedStack(new ItemStack(GCVenus2Items.spaceship, 1, 3), 139, 87 + changey));
    }
}
