package spacecraft.mods.galacticraft.venus.nei;
...
public class NEIGalacticraftVenusConfig implements IConfigureNEI
{
    ...
    public void registerRecipes()
    {
        ...
        input1.add(new PositionedStack(new ItemStack(GCVenusItems.venus2ItemBasic, 1, 3), 36, -6 + 0 * 18 + 16 + changey));
        input1.add(new PositionedStack(new ItemStack(GCVenusItems.venus2ItemBasic, 1, 3), 36, -6 + 1 * 18 + 16 + changey));
        input1.add(new PositionedStack(new ItemStack(GCVenusItems.venus2ItemBasic, 1, 3), 36, -6 + 2 * 18 + 16 + changey));
        input1.add(new PositionedStack(new ItemStack(GCVenusItems.venus2ItemBasic, 1, 3), 36, -6 + 3 * 18 + 16 + changey));
        input1.add(new PositionedStack(new ItemStack(GCVenusItems.venus2ItemBasic, 1, 3), 36, -6 + 4 * 18 + 16 + changey));
        input1.add(new PositionedStack(new ItemStack(GCVenusItems.venus2ItemBasic, 1, 3), 54, -6 + 0 * 18 + 16 + changey));
        input1.add(new PositionedStack(new ItemStack(GCVenusItems.venus2ItemBasic, 1, 3), 54, -6 + 1 * 18 + 16 + changey));
        input1.add(new PositionedStack(new ItemStack(GCVenusItems.venus2ItemBasic, 1, 3), 54, -6 + 2 * 18 + 16 + changey));
        input1.add(new PositionedStack(new ItemStack(GCVenusItems.venus2ItemBasic, 1, 3), 54, -6 + 3 * 18 + 16 + changey));
        input1.add(new PositionedStack(new ItemStack(GCVenusItems.venus2ItemBasic, 1, 3), 54, -6 + 4 * 18 + 16 + changey));
        ...
        this.registerRocketBenchRecipe(input1, new PositionedStack(new ItemStack(GCVenusItems.spaceship, 1, 0), 139, 87 + changey));
        ...
        this.registerRocketBenchRecipe(input2, new PositionedStack(new ItemStack(GCVenusItems.spaceship, 1, 1), 139, 87 + changey));
        ...
        input2.add(new PositionedStack(new ItemStack(Block.chest), 90 + 0 * 26, -15 + changey));
        input2.add(new PositionedStack(new ItemStack(Block.chest), 90 + 1 * 26, -15 + changey));
        this.registerRocketBenchRecipe(input2, new PositionedStack(new ItemStack(GCVenusItems.spaceship, 1, 2), 139, 87 + changey));
        ...
        input2.add(new PositionedStack(new ItemStack(Block.chest), 90 + 1 * 26, -15 + changey));
        input2.add(new PositionedStack(new ItemStack(Block.chest), 90 + 2 * 26, -15 + changey));
        this.registerRocketBenchRecipe(input2, new PositionedStack(new ItemStack(GCVenusItems.spaceship, 1, 3), 139, 87 + changey));
    }
}
