...
public class VenusBlocks 
        ...
        public final static Block VenusCobblestone = new GCVenusCobblestone(613, Material.rock) .setHardness(1.5F).setStepSound(Block.soundStoneFootstep) .setUnlocalizedName("VenusCobblestone") .setTextureName("galacticraftvenus:cobblestoneVenus");
        ...
        //Block Venus Basalt
        public final static Block VenusBasalt = new GCVenusBlock(625, Material.rock) .setHardness(1.5F).setStepSound(Block.soundStoneFootstep) .setUnlocalizedName("VenusBasalt") .setTextureName("galacticraftvenus:venusBasalt");                                
