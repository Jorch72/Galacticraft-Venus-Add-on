...
public class GCVenus2EntityRocketT3 extends EntityTieredRocket implements IInventory
{
    ...
    public GCVenus2EntityRocketT3(World par1World)
    {
        super(par1World);
    }

    public GCVenus2EntityRocketT3(World par1World, double par2, double par4, double par6, EnumRocketType rocketType)
    {
        super(par1World);
    ...
    public GCVenus2EntityRocketT3(World par1World, double par2, double par4, double par6, boolean reversed, EnumRocketType rocketType, ItemStack[] inv)
    {
    ...
    public void onTeleport(EntityPlayerMP player)
    {
        ...
        if (playerBase != null)
        {
            ...
            playerBase.setRocketItem(GCVenus2Items.spaceship);
    ...
    public List<ItemStack> getItemsDropped()
    {
        ...
        items.add(new ItemStack(GCVenus2Items.spaceship, 1, this.rocketType.getIndex()));
