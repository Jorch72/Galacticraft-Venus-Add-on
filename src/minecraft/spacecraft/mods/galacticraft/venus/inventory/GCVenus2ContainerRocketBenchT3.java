...
import spacecraft.mods.galacticraft.venus.util.RecipeUtilVenus2;
...
public class GCVenus2ContainerRocketBenchT3 extends Container
{
    public GCVenus2InventoryRocketBenchT3 craftMatrix = new GCVenus2InventoryRocketBenchT3(this);
    public IInventory craftResult = new InventoryCraftResult();
    private final World worldObj;

    public GCVenus2ContainerRocketBenchT3(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
    {
        final int change = 27;
        ...
        // Cone
        this.addSlotToContainer(new GCVenus2SlotRocketBenchT3(this.craftMatrix, 1, 48, -8 + change, x, y, z, par1InventoryPlayer.player));

        // Body
        for (var6 = 0; var6 < 5; ++var6)
        {
            this.addSlotToContainer(new GCVenus2SlotRocketBenchT3(this.craftMatrix, 2 + var6, 39, -6 + var6 * 18 + 16 + change, x, y, z, par1InventoryPlayer.player));
        }

        // Body Right
        for (var6 = 0; var6 < 5; ++var6)
        {
            this.addSlotToContainer(new GCVenus2SlotRocketBenchT3(this.craftMatrix, 7 + var6, 57, -6 + var6 * 18 + 16 + change, x, y, z, par1InventoryPlayer.player));
        }

        // Left fins
        this.addSlotToContainer(new GCVenus2SlotRocketBenchT3(this.craftMatrix, 12, 21, 64 + change, x, y, z, par1InventoryPlayer.player));
        this.addSlotToContainer(new GCVenus2SlotRocketBenchT3(this.craftMatrix, 13, 21, 82 + change, x, y, z, par1InventoryPlayer.player));
        this.addSlotToContainer(new GCVenus2SlotRocketBenchT3(this.craftMatrix, 14, 21, 100 + change, x, y, z, par1InventoryPlayer.player));

        // Engine
        this.addSlotToContainer(new GCVenus2SlotRocketBenchT3(this.craftMatrix, 15, 48, 100 + change, x, y, z, par1InventoryPlayer.player));

        // Right fins
        this.addSlotToContainer(new GCVenus2SlotRocketBenchT3(this.craftMatrix, 16, 75, 64 + change, x, y, z, par1InventoryPlayer.player));
        this.addSlotToContainer(new GCVenus2SlotRocketBenchT3(this.craftMatrix, 17, 75, 82 + change, x, y, z, par1InventoryPlayer.player));
        this.addSlotToContainer(new GCVenus2SlotRocketBenchT3(this.craftMatrix, 18, 75, 100 + change, x, y, z, par1InventoryPlayer.player));

        // Addons
        for (int var8 = 0; var8 < 3; var8++)
        {
            this.addSlotToContainer(new GCVenus2SlotRocketBenchT3(this.craftMatrix, 19 + var8, 93 + var8 * 26, -15 + change, x, y, z, par1InventoryPlayer.player));
        }
