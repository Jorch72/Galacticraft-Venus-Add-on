...
public class VenusSlotRocketBenchT3 extends Slot
{
    private final int index;
    private final int x, y, z;
    private final EntityPlayer player;

    public VenusSlotRocketBenchT3(IInventory par2IInventory, int par3, int par4, int par5, int x, int y, int z, EntityPlayer player)
    {
    ...
    public boolean isItemValid(ItemStack par1ItemStack)
    {
        ...
        case 2:
            return par1ItemStack.getItem().itemID == GalacticraftVenus.VenusPlate.itemID && par1ItemStack.getItemDamage() == 3 ? true : false;
        case 3:
            return par1ItemStack.getItem().itemID == GalacticraftVenus.VenusPlate.itemID && par1ItemStack.getItemDamage() == 3 ? true : false;
        case 4:
            return par1ItemStack.getItem().itemID == GalacticraftVenus.VenusPlate.itemID && par1ItemStack.getItemDamage() == 3 ? true : false;
