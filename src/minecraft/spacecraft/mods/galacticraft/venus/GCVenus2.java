...
import spacecraft.mods.galacticraft.venus.dimension.GCVenus2TeleportType;
...
public class GCVenus2
{
    ...
    @SidedProxy(clientSide = "spacecraft.mods.galacticraft.venus.client.ClientProxyVenus2", serverSide = "spacecraft.mods.galacticraft.venus.CommonProxyVenus2")
