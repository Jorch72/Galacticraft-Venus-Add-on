...
public class VenusItemSchematic extends GCCoreItemSchematic implements ISchematicItem
{
...
//    @SuppressWarnings({ "unchecked", "rawtypes" })
    ...
    {
        for (int i = 0; i < VenusItemSchematic.names.length; i++)
        {
    ...
    public void registerIcons(IconRegister iconRegister)
    {
        ...
        this.icons[0] = iconRegister.registerIcon(GalacticraftDevVenus.TEXTURE_PREFIX + "schematic_rocketT3");
    }
