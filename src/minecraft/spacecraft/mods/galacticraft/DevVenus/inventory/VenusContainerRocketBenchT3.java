...
public class VenusContainerRocketBenchT3 extends Container
{
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par1)
    {
        ...
        if (var3 != null && var3.getHasStack())
        {
            ...
            else if (var2.getItem().itemID == GalacticraftVenus.HeavyVenusPlate.itemID && !((Slot) this.inventorySlots.get(2)).getHasStack())
            {
            ...
            else if (var2.getItem().itemID == GalacticraftVenus.HeavyVenusPlate.itemID && !((Slot) this.inventorySlots.get(3)).getHasStack())
            {
            ...
            else if (var2.getItem().itemID == GalacticraftVenus.HeavyVenusPlate.itemID && !((Slot) this.inventorySlots.get(4)).getHasStack())
            {
            ...
            else if (var2.getItem().itemID == GalacticraftVenus.HeavyVenusPlate.itemID && !((Slot) this.inventorySlots.get(5)).getHasStack())
            {
            ...
            else if (var2.getItem().itemID == GalacticraftVenus.HeavyVenusPlate.itemID && !((Slot) this.inventorySlots.get(6)).getHasStack())
            {
            ...
            else if (var2.getItem().itemID == GalacticraftVenus.HeavyVenusPlate.itemID && !((Slot) this.inventorySlots.get(7)).getHasStack())
            {
            ...
            else if (var2.getItem().itemID == GalacticraftVenus.HeavyVenusPlate.itemID && !((Slot) this.inventorySlots.get(8)).getHasStack())
            {
            ...
            else if (var2.getItem().itemID == GalacticraftVenus.HeavyVenusPlate.itemID && !((Slot) this.inventorySlots.get(9)).getHasStack())
            {
