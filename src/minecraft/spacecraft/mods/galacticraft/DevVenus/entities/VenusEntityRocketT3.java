package spacecraft.mods.galacticraft.DevVenus.entities;
...
public class VenusEntityRocketT3 extends EntityTieredRocket implements IInventory
{
    ...
    public VenusEntityRocketT3(World par1World)
    {
        super(par1World);
    }

    public VenusEntityRocketT3(World par1World, double par2, double par4, double par6, EnumRocketType rocketType)
    {
        super(par1World);
    ...
    public VenusEntityRocketT3(World par1World, double par2, double par4, double par6, boolean reversed, EnumRocketType rocketType, ItemStack[] inv)
    {
