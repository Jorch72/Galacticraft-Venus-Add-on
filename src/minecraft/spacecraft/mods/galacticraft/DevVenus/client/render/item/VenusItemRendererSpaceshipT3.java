package spacecraft.mods.galacticraft.DevVenus.client.render.item;
...
public class VenusItemRendererSpaceshipT3 extends GCCoreItemRendererSpaceship
{
    public VenusItemRendererSpaceshipT3(EntitySpaceshipBase spaceship, ModelBase model, ResourceLocation texture)
    {
