...
public class GCPlutoBlocksConfigManager
{
    public static boolean loaded;

    static Configuration configuration;

    public GCPlutoBlocksConfigManager(File file)
    {
        if (!GCPlutoBlocksConfigManager.loaded)
        {
            GCPlutoBlocksConfigManager.configuration = new Configuration(file);
    ...
    private void setDefaultValues()
    {
        try
        {
            GCPlutoBlocksConfigManager.configuration.load();
...
//			GCPlutoBlocksConfigManager.VenusCopperOreID= GCPlutoBlocksConfigManager.configuration.get("Blocks", "Venus Copper Ore ID", 7018).getInt(7018);
        ...
        {
        	GCPlutoBlocksConfigManager.configuration.save();
        	GCPlutoBlocksConfigManager.loaded = true;
        }
    }
}