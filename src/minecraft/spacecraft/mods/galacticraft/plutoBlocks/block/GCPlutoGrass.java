...
public class GCPlutoGrass extends Block implements IPlantableBlock, ITerraformableBlock
{
	public GCPlutoGrass(int id, Material material)
    {
    ...
    {
        return this.blockID == PlutoBlocks.PlutoDirt.blockID ? 4 : 0;
	}
