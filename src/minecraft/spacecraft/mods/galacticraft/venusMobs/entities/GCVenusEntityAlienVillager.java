...
public class GCVenusEntityAlienVillager extends EntityAgeable implements IEntityBreathable
{
    ...
    public GCVenusEntityAlienVillager(World par1World)
    {
        super(par1World);
    ...
    public GCVenusEntityAlienVillager func_90012_b(EntityAgeable par1EntityAgeable)
    {
        final GCVenusEntityAlienVillager entityvillager = new GCVenusEntityAlienVillager(this.worldObj);
