...
public class GCVenusModelVillager extends ModelVillager
{
    public ModelRenderer brain;

    public GCVenusModelVillager(float par1)
    {
        this(par1, 0.0F, 64, 64);
    }

    public GCVenusModelVillager(float par1, float par2, int par3, int par4)
    {
        super(par1, par2, 0, 0);
