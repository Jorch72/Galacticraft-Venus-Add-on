package spacecraft.mods.galacticraft.pluto.client.fx;
...
public class GCPlutoEntityDropParticleFX extends EntityFX
{
    ...
    public GCPlutoEntityDropParticleFX(World par1World, double par2, double par4, double par6, Material par8Material)
    {
