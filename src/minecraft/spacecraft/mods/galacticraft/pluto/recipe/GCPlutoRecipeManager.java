package spacecraft.mods.galacticraft.pluto.recipe;

import java.util.HashMap;

import spacecraft.mods.galacticraft.pluto.items.GCPlutoItems;
import spacecraft.mods.galacticraft.pluto.util.GCPlutoUtil;
...
public class GCPlutoRecipeManager
{
    public static void loadRecipes()
    {
        GCPlutoRecipeManager.addUniversalRecipes();
    }
