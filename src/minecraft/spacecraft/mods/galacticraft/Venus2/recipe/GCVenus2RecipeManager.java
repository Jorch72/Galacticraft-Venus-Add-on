...
public class GCVenus2RecipeManager
{
    ...
    {
        OreDictionary.registerOre("ingotDesh", new ItemStack(GCVenus2Items.marsItemBasic, 1, 2));
        OreDictionary.registerOre("plateDesh", new ItemStack(GCVenus2Items.marsItemBasic, 1, 5));
        OreDictionary.registerOre("plateHeavyT2", new ItemStack(GCVenus2Items.marsItemBasic, 1, 3));

        RecipeUtil.addRecipe(new ItemStack(GCVenus2Items.gemBoots), new Object[] { "X X", "X X", 'X', new ItemStack(GCVenus2Items.marsItemBasic, 1, 2) });
...
//        RecipeUtil.addRecipe(new ItemStack(GCMarsBlocks.machine, 1, 4), new Object[] { "XYX", "XZX", "XYX", 'X', "plateDesh", 'Y', "plateHeavyT2", 'Z', Item.bed });
        ...
        RecipeUtil.addRecipe(new ItemStack(GCVenus2Items.marsItemBasic, 1, 1), new Object[] { "X", "X", 'X', "ingotDesh" });

        RecipeUtil.addRecipe(new ItemStack(GCVenus2Items.marsItemBasic, 1, 4), new Object[] { "XWX", "XYX", " Z ", 'W', Item.diamond, 'X', Item.leather, 'Y', Item.slimeBall, 'Z', Block.chest });

        RecipeUtil.addRecipe(new ItemStack(GCVenus2Items.gemSword), new Object[] { "X", "X", "Y", 'X', new ItemStack(GCVenus2Items.marsItemBasic, 1, 2), 'Y', new ItemStack(GCVenus2Items.marsItemBasic, 1, 1) });

        RecipeUtil.addRecipe(new ItemStack(GCVenus2Items.gemPickaxe), new Object[] { "XXX", " Y ", " Y ", 'X', new ItemStack(GCVenus2Items.marsItemBasic, 1, 2), 'Y', new ItemStack(GCVenus2Items.marsItemBasic, 1, 1) });

        RecipeUtil.addRecipe(new ItemStack(GCVenus2Items.gemSpade), new Object[] { "X", "Y", "Y", 'X', new ItemStack(GCVenus2Items.marsItemBasic, 1, 2), 'Y', new ItemStack(GCVenus2Items.marsItemBasic, 1, 1) });

        RecipeUtil.addRecipe(new ItemStack(GCVenus2Items.gemHoe), new Object[] { "XX", "Y ", "Y ", 'X', new ItemStack(GCVenus2Items.marsItemBasic, 1, 2), 'Y', new ItemStack(GCVenus2Items.marsItemBasic, 1, 1) });

        RecipeUtil.addRecipe(new ItemStack(GCVenus2Items.gemHoe), new Object[] { "XX", " Y", " Y", 'X', new ItemStack(GCVenus2Items.marsItemBasic, 1, 2), 'Y', new ItemStack(GCVenus2Items.marsItemBasic, 1, 1) });

        RecipeUtil.addRecipe(new ItemStack(GCVenus2Items.gemAxe), new Object[] { "XX", "XY", " Y", 'X', new ItemStack(GCVenus2Items.marsItemBasic, 1, 2), 'Y', new ItemStack(GCVenus2Items.marsItemBasic, 1, 1) });

        RecipeUtil.addRecipe(new ItemStack(GCVenus2Items.gemAxe), new Object[] { "XX", "YX", "Y ", 'X', new ItemStack(GCVenus2Items.marsItemBasic, 1, 2), 'Y', new ItemStack(GCVenus2Items.marsItemBasic, 1, 1) });

        RecipeUtil.addRecipe(new ItemStack(GCVenus2Items.gemHelmet), new Object[] { "XXX", "X X", 'X', new ItemStack(GCVenus2Items.marsItemBasic, 1, 2) });

        RecipeUtil.addRecipe(new ItemStack(GCVenus2Items.gemChestplate), new Object[] { "X X", "XXX", "XXX", 'X', new ItemStack(GCVenus2Items.marsItemBasic, 1, 2) });

        RecipeUtil.addRecipe(new ItemStack(GCVenus2Items.gemLeggings), new Object[] { "XXX", "X X", "X X", 'X', new ItemStack(GCVenus2Items.marsItemBasic, 1, 2) });

        RecipeUtil.addRecipe(new ItemStack(GCVenus2Items.marsItemBasic, 9, 2), new Object[] { "X", 'X', new ItemStack(GCVenus2Blocks.marsBlock, 1, 8) });
...
//            CraftingManager.getInstance().addShapelessRecipe(new ItemStack(GCMarsBlocks.tintedGlassPane, 1, 15 - var2), new Object[] { new ItemStack(Item.dyePowder, 1, var2), Block.thinGlass, OreDictionary.getOres("plateDesh").get(0) });
        ...
        // Smelting
        FurnaceRecipes.smelting().addSmelting(GCVenus2Items.marsItemBasic.itemID, 0, new ItemStack(GCVenus2Items.marsItemBasic, 1, 2), 0.2F);
        ...
        FurnaceRecipes.smelting().addSmelting(GCVenus2Blocks.marsBlock.blockID, 2, new ItemStack(GCVenus2Items.marsItemBasic, 1, 2), 0.2F);
        ...
        input.put(2, new ItemStack(GCVenus2Items.marsItemBasic, 1, 3));
        input.put(3, new ItemStack(GCVenus2Items.marsItemBasic, 1, 3));
        input.put(4, new ItemStack(GCVenus2Items.marsItemBasic, 1, 3));
        input.put(5, new ItemStack(GCVenus2Items.marsItemBasic, 1, 3));
        input.put(6, new ItemStack(GCVenus2Items.marsItemBasic, 1, 3));
        input.put(7, new ItemStack(GCVenus2Items.marsItemBasic, 1, 3));
        input.put(8, new ItemStack(GCVenus2Items.marsItemBasic, 1, 3));
        input.put(9, new ItemStack(GCVenus2Items.marsItemBasic, 1, 3));
        input.put(10, new ItemStack(GCVenus2Items.marsItemBasic, 1, 3));
        input.put(11, new ItemStack(GCVenus2Items.marsItemBasic, 1, 3));
