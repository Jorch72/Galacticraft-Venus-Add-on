...
import spacecraft.mods.galacticraft.Venus2.world.gen.dungeon.GCMarsRoomBoss;
import spacecraft.mods.galacticraft.Venus2.world.gen.dungeon.GCMarsRoomChests;
import spacecraft.mods.galacticraft.Venus2.world.gen.dungeon.GCMarsRoomEmpty;
import spacecraft.mods.galacticraft.Venus2.world.gen.dungeon.GCMarsRoomSpawner;
import spacecraft.mods.galacticraft.Venus2.world.gen.dungeon.GCMarsRoomTreasure;
...
{
    final short topBlockID = (short) GCVenus2Blocks.marsBlock.blockID;
    final byte topBlockMeta = 5;
    final short fillBlockID = (short) GCVenus2Blocks.marsBlock.blockID;
    final byte fillBlockMeta = 6;
    final short lowerBlockID = (short) GCVenus2Blocks.marsBlock.blockID;
    ...
    private final GCCoreMapGenDungeon dungeonGenerator = new GCCoreMapGenDungeon(GCVenus2Blocks.marsBlock.blockID, 7, 8, 16, 6);
    ...
    {
        return GCVenus2ConfigManager.generateOtherMods ? "RandomLevelSource" : "MarsLevelSource";
    }
