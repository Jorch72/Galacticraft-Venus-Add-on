                                ...
                                for (int var50 = caveMaxY - 1; var50 >= caveMinY; --var50)
                                {
                                    ...
                                    if (var59 * var59 + var51 * var51 + var46 * var46 < 1.0D)
                                    {
                                        if (var51 > -0.7D)
                                        {
                                            ...
                                            {
                                                if (arrayOfIDs[coordsAbove] == GCVenus2Blocks.marsBlock.blockID && this.rand.nextInt(200) == 0)
                                                {
                                                    int modifier = 0;
...
//                                                        arrayOfIDs[var50 + modifier << 8 | var45 << 4 | var42] = (short) GCMarsBlocks.vine.blockID;
                                                ...
                                                else if (arrayOfIDs[coordsBelow] == GCVenus2Blocks.marsBlock.blockID && this.rand.nextInt(200) == 0)
                                                {
