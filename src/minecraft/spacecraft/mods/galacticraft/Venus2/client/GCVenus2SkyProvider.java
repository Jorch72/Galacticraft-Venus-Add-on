...
public class GCVenus2SkyProvider extends IRenderHandler
{
    ...
    {
        GCVenus2WorldProvider gcProvider = null;

        if (world.provider instanceof GCVenus2WorldProvider)
        {
            gcProvider = (GCVenus2WorldProvider) world.provider;
        }
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(GCVenus2SkyProvider.galaxyTexture);
        ...
        var12 = 30.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(GCVenus2SkyProvider.sunTexture);
        var23.startDrawingQuads();
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(GCVenus2SkyProvider.overworldTexture);
        var23.startDrawingQuads();
        var23.addVertexWithUV(-var12, -100.0D, var12, 0, 1);
        var23.addVertexWithUV(var12, -100.0D, var12, 1, 1);
        var23.addVertexWithUV(var12, -100.0D, -var12, 1, 0);
