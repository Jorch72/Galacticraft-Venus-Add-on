...
public class GCVenus2EntityDropParticleFX extends EntityFX
{
    ...
    public GCVenus2EntityDropParticleFX(World par1World, double par2, double par4, double par6, Material par8Material)
    {
