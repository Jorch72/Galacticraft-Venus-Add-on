...
public class GCMarsItemArmor extends ItemArmor
{
    ...
    {
        if (this.material == GCMarsItems.ARMORGEM)
        {
            if (stack.getItem().itemID == GCMarsItems.gemHelmet.itemID)
            {
                return "textures/model/armor/gem_1.png";
            }
            else if (stack.getItem().itemID == GCMarsItems.gemChestplate.itemID || stack.getItem().itemID == GCMarsItems.gemBoots.itemID)
            {
                return "textures/model/armor/gem_2.png";
            }
            else if (stack.getItem().itemID == GCMarsItems.gemLeggings.itemID)
            {
