...
public class GCMarsRecipeManager
{
    ...
    private static void addUniversalRecipes()
    {
        ...
        RecipeUtil.addRecipe(new ItemStack(GCMarsItems.gemBoots), new Object[] { "X X", "X X", 'X', new ItemStack(GCMarsItems.marsItemBasic, 1, 2) });
...
//        RecipeUtil.addRecipe(new ItemStack(GCMarsBlocks.machine, 1, 4), new Object[] { "XYX", "XZX", "XYX", 'X', "plateDesh", 'Y', "plateHeavyT2", 'Z', Item.bed });
        ...
        RecipeUtil.addRecipe(new ItemStack(GCMarsItems.gemSword), new Object[] { "X", "X", "Y", 'X', new ItemStack(GCMarsItems.marsItemBasic, 1, 2), 'Y', new ItemStack(GCMarsItems.marsItemBasic, 1, 1) });

        RecipeUtil.addRecipe(new ItemStack(GCMarsItems.gemPickaxe), new Object[] { "XXX", " Y ", " Y ", 'X', new ItemStack(GCMarsItems.marsItemBasic, 1, 2), 'Y', new ItemStack(GCMarsItems.marsItemBasic, 1, 1) });

        RecipeUtil.addRecipe(new ItemStack(GCMarsItems.gemSpade), new Object[] { "X", "Y", "Y", 'X', new ItemStack(GCMarsItems.marsItemBasic, 1, 2), 'Y', new ItemStack(GCMarsItems.marsItemBasic, 1, 1) });

        RecipeUtil.addRecipe(new ItemStack(GCMarsItems.gemHoe), new Object[] { "XX", "Y ", "Y ", 'X', new ItemStack(GCMarsItems.marsItemBasic, 1, 2), 'Y', new ItemStack(GCMarsItems.marsItemBasic, 1, 1) });

        RecipeUtil.addRecipe(new ItemStack(GCMarsItems.gemHoe), new Object[] { "XX", " Y", " Y", 'X', new ItemStack(GCMarsItems.marsItemBasic, 1, 2), 'Y', new ItemStack(GCMarsItems.marsItemBasic, 1, 1) });

        RecipeUtil.addRecipe(new ItemStack(GCMarsItems.gemAxe), new Object[] { "XX", "XY", " Y", 'X', new ItemStack(GCMarsItems.marsItemBasic, 1, 2), 'Y', new ItemStack(GCMarsItems.marsItemBasic, 1, 1) });

        RecipeUtil.addRecipe(new ItemStack(GCMarsItems.gemAxe), new Object[] { "XX", "YX", "Y ", 'X', new ItemStack(GCMarsItems.marsItemBasic, 1, 2), 'Y', new ItemStack(GCMarsItems.marsItemBasic, 1, 1) });

        RecipeUtil.addRecipe(new ItemStack(GCMarsItems.gemHelmet), new Object[] { "XXX", "X X", 'X', new ItemStack(GCMarsItems.marsItemBasic, 1, 2) });

        RecipeUtil.addRecipe(new ItemStack(GCMarsItems.gemChestplate), new Object[] { "X X", "XXX", "XXX", 'X', new ItemStack(GCMarsItems.marsItemBasic, 1, 2) });

        RecipeUtil.addRecipe(new ItemStack(GCMarsItems.gemLeggings), new Object[] { "XXX", "X X", "X X", 'X', new ItemStack(GCMarsItems.marsItemBasic, 1, 2) });
